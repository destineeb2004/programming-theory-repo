...
public class SpawnManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        orangeColor = orange.GetComponent<MeshRenderer>().sharedMaterial.color;
        bananaColor = banana.GetComponent<MeshRenderer>().sharedMaterial.color;
        appleColor = apple.GetComponent<MeshRenderer>().sharedMaterial.color;
        blueberryColor = blueberry.GetComponent<MeshRenderer>().sharedMaterial.color;
        plumColor = plum.GetComponent<MeshRenderer>().sharedMaterial.color;
    }
    ...
    public void GetColor(GameObject fruit)
    {
        Debug.Log(fruit.GetComponent<MeshRenderer>().sharedMaterial.color);
    }
}
